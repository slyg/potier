...
var _constantsShopConstants = require('../constants/ShopConstants');

var _constantsShopConstants2 = _interopRequireDefault(_constantsShopConstants);

var _dispatcherShopAppDispatcher = require('../dispatcher/ShopAppDispatcher');

var _dispatcherShopAppDispatcher2 = _interopRequireDefault(_dispatcherShopAppDispatcher);

var _servicesShopService = require('../services/ShopService');

var _servicesShopService2 = _interopRequireDefault(_servicesShopService);
...
function queryForBooks() {
  ...
  _servicesShopService2['default'].getBooks();
}
...
function receiveBestOffer(bestOffer) {
...
function addBookToCart(book) {
  ...
  _servicesShopService2['default'].getBestOffer(_storesCartStore2['default'].getTotalPrice(), _.map(_storesCartStore2['default'].getItems(), function (item) {
    return item.isbn;
  }));
}
...
var _actionsShopActions = require('../actions/ShopActions');
...
var _default = (function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function _onAddToCart() {
      (0, _actionsShopActions.addBookToCart)(this.props.item);
    }
  }, {
    key: 'render',
...
var _BookItem = require('./BookItem');
      ...
      var bookItems = _.map(this.props.items, function (bookItem) {
        return(
          ...
          React.createElement(
            'li',
            { key: bookItem.isbn },
            React.createElement(_BookItem2['default'], { item: bookItem })
          )
          /* jshint ignore:end */
    ...
    value: function render() {
      ...
      var cartItems = _.map(this.props.cart.books, function (item) {
        ...
        return React.createElement(
          'li',
          { key: item.isbn },
          React.createElement(_CartItem2['default'], { item: item })
        );
        /* jshint ignore:end */
      });
...
var _default = (function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function _onRemoveFromCart() {
      (0, _actionsShopActions.removeFromCart)(this.props.item);
    }
  }, {
    key: 'render',
    value: function render() {
...
var _storesBookStore = require('../stores/BookStore');
...
var _storesBestOfferStore = require('../stores/BestOfferStore');
...
var _default = (function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function componentDidMount() {
      ...
      _.each([_storesBookStore2['default'], _storesCartStore2['default'], _storesBestOfferStore2['default']], (function (store) {
    ...
    value: function render() {
      ...
      if (this.state.cart.totalPrice > 0) {
        ...
        cart = React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'cart pbl' },
            React.createElement(_Cart2['default'], { cart: this.state.cart })
          ),
          React.createElement(
            'div',
            { className: 'offer pbl' },
            React.createElement(_PayBox2['default'], { discount: this.state.discount, cart: this.state.cart })
          )
        );
        /* jshint ignore:end */
      }
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'book-list' },
          React.createElement(_BookList2['default'], { items: this.state.books })
        ),
        React.createElement(
          'div',
          { className: 'cart-box' },
...
var _componentsShopApp = require('./components/ShopApp');

var _componentsShopApp2 = _interopRequireDefault(_componentsShopApp);

React.render(
/* jshint ignore:start */
React.createElement(_componentsShopApp2['default'], null),
/* jshint ignore:end */
